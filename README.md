...
> **Actualización (2026-07):** el catálogo tiene **13 planes** activos: a los planes anuales y temáticos se sumaron Marcos en 16 días, Primeros pasos con Jesús, Conocer a Jesús, Semana Santa y Adviento. El orden de la lista es **curado y determinista**, no por duración — ver `PLAN_ORDER` en `src/lib/db.js`.
